...
const commands = [
    new SlashCommandBuilder()
        .setName("ping")
        .setDescription("Replies with pong! (e)")
        .toJSON(),
    new SlashCommandBuilder()
        .setName("nothing")
    ...
    new SlashCommandBuilder()
        ...
        .addUserOption((option) =>
            option
                .setName("member")
                .setDescription("See someone else's points")
                .setRequired(false)
        )
        .toJSON(),
    new SlashCommandBuilder()
        ...
        .addNumberOption((option) =>
            option
                .setName("points")
                .setDescription(
                    "Number of points in the case of adding a new role"
                )
                .setRequired(false)
        )
        .toJSON(),
    ...
    new SlashCommandBuilder()
        .setName("roles")
        .setDescription("See all available roles")
        .toJSON(),
];
